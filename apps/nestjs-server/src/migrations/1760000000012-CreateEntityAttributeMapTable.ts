// apps/nestjs-server/src/migrations/1760000000012-CreateEntityAttributeMapTable.ts
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`
            CREATE TABLE entity_attribute_map (
                entity_attribute_map_id INTEGER NOT NULL,
                source_attribute_id     INTEGER NOT NULL,
                deptype_id              VARCHAR NOT NULL,
                change_id               INTEGER NOT NULL,
                CONSTRAINT pk_entity_attribute_map PRIMARY KEY (entity_attribute_map_id, source_attribute_id, deptype_id),
        ...
        `);
        await queryRunner.query(`
            COMMENT ON COLUMN entity_attribute_map.entity_attribute_map_id IS 'Идентификатор записи'
        `);
        await queryRunner.query(`
