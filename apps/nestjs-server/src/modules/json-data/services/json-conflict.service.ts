...
export class JsonConflictService {
    private readonly logger = new Logger(JsonConflictService.name);
    ...
    async isSafeToUpdate(
        ...
        const usageCheck = await this.dependencyCheckService.checkMartUsage(targetEntities, sourceProcessId);
