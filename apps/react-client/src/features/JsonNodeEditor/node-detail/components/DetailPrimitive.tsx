...
import {
	type StringSubtypeValidator,
	validateStringSubtype,
} from "../primitive/helpers/string-subtype.helper";
...
const _DetailPrimitive = ({ chip, value }: Props) => {
	const [isStringSubtypeLoading, setIsStringSubtypeLoading] = useState<boolean>(
		isString(value),
	);
	const [stringSubtypeValidator, setStringSubtypeValidator] =
		useState<StringSubtypeValidator>(ALL_FALSE_STRING_SUBTYPE_VALIDATOR);
