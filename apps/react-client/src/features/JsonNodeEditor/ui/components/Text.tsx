...
const _Text = ({
	...
	if (h1) {
		return (
			<h1
				className={extendClassName(
					"mb-2 text-5xl font-bold leading-normal tracking-tighter text-default-900",
				)}
				{...props}
			>
				{children}
		...
		return (
			<h2
				className={extendClassName(
					"mb-2 text-4xl font-semibold tracking-tighter text-default-900",
				)}
				{...props}
			>
				{children}
		...
		return (
			<h3
				className={extendClassName(
					"mb-2 text-2xl font-semibold tracking-tighter text-default-900",
				)}
				{...props}
			>
				{children}
		...
		return (
			<h4
				className={extendClassName(
					"mb-2 text-xl font-semibold tracking-tighter text-default-900",
				)}
				{...props}
			>
				{children}
		...
		return (
			<h5
				className={extendClassName(
					"mb-2 text-base font-semibold tracking-tighter text-default-900",
				)}
				{...props}
			>
				{children}
		...
		return (
			<h6
				className={extendClassName(
					"mb-2 text-sm font-semibold tracking-tight text-default-900",
				)}
				{...props}
			>
				{children}
		...
		return (
			<p
				className={extendClassName(
					"text-base leading-relaxed tracking-tighter text-default-900",
				)}
				{...props}
			>
				{children}
