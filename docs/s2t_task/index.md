...
Предпосылки кода - система в режиме alpha, есть готовый ui на фронте, есть кнопки для ипорта и экспорта, есть эндпоинты для валидации, импорта и экспорта, это всё нужно использовать. есть старые mvp эндпоинты которые работают как пример (нужно продумать как отключить/заменить/преобразовать их для использования для актуальных эндпоитов):
...
@index.md  - прочитай и выведи в отдельный md план о имплементации фичи ипморта s2t.