...
import { type ForwardedRef, type ReactElement, forwardRef, memo } from "react";
...
const _NodeDetailCard = (
	{ chip, value, childObjectNodeId }: Props,
...
export const NodeDetailCard = memo(
	forwardRef<HTMLDivElement, Props>(_NodeDetailCard),
);
