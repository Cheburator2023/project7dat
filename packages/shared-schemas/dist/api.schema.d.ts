...
export declare const DataLineageItemSchema: z.ZodObject<{
    id: z.ZodString;
    name: z.ZodString;
...
export declare const DataLineageListResponseSchema: z.ZodObject<{
    total: z.ZodNumber;
    page: z.ZodNumber;
    limit: z.ZodNumber;
    totalPages: z.ZodNumber;
...
export declare const CreateDataLineageItemSchema: z.ZodObject<{
...
export declare const UpdateDataLineageItemSchema: z.ZodObject<{
    name: z.ZodOptional<z.ZodString>;
    description: z.ZodOptional<z.ZodString>;
...
export declare const CommitDataLineageSchema: z.ZodObject<{
    message: z.ZodString;
    data: z.ZodObject<{
        desc: z.ZodObject<{
            appId: z.ZodString;
...
export type PaginationResponse<T = unknown> = Omit<z.infer<typeof PaginationResponseSchema>, 'data'> & {
    data: T[];
};
export type DataLineageItem = z.infer<typeof DataLineageItemSchema>;
export type DataLineageListResponse = z.infer<typeof DataLineageListResponseSchema>;
export type CreateDataLineageItemInput = z.infer<typeof CreateDataLineageItemSchema>;
export type UpdateDataLineageItemInput = z.infer<typeof UpdateDataLineageItemSchema>;
export type CommitDataLineageInput = z.infer<typeof CommitDataLineageSchema>;
