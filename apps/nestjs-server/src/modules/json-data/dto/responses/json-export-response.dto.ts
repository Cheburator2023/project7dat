...
export class JsonExportEntityDto {
	...
	@ApiProperty({
		description: "Наименование системы сущности в РБД DL",
		required: false,
	})
	@IsOptional()
	@IsString()
...
export class JsonExportDependencyDto {
	...
	@ApiProperty({
		description: "Уникальный идентификатор сущности источник в РБД DL",
		required: false,
	})
	@IsOptional()
	@IsNumber()
	...
	@ApiProperty({
		description: "Уникальный идентификатор процесса DAG в РБД",
		required: false,
	})
	@IsOptional()
	@IsNumber()
...
export class JsonExportMappingDto {
	...
	@ApiProperty({
		description: "Описание связи (маппинга) источник - цель",
		required: false,
	})
	@IsOptional()
	@IsString()
	...
	@ApiProperty({
		description: "Уникальный идентификатор сущности 'цель'",
		required: false,
	})
	@IsOptional()
	@IsNumber()
